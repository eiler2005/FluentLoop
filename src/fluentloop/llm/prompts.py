...
def _material_extraction_prompt(payload: dict[str, Any]) -> str:
    ...
    return (
        ...
        "lessons. If the material is substantial, return 20-30 targets. Prefer "
        "reusable chunks, collocations, reporting/grammar patterns, and likely "
        "mistake risks. Avoid trivial standalone words.\n"
