...
| 22 | [breakthrough-roadmap](EPIC-22-breakthrough-roadmap.md) | In progress | Pedagogy upgrades — Sprint 1 foundation landed: layered feedback, sub-day SRS, Russian L1 hit list, evaluation/reflection/chunk-import scaffolds, and EPIC-22 practice command entrypoints. |
