...
| 🌙 19:00 | Викторина из 4 вариантов | Нажать вариант |
...
Приходит нативным опросом Telegram. После ответа бот присылает разбор:
...
| `/settings` | время слотов и количество слов в день |
...
| `/review` | средне | спрашивает слова, у которых подошёл срок — те самые, что были утром |
| `/practice vocab` | полноценно | лексический урок вокруг этих слов: коллокации, перефразирование, пропуски, обратный перевод |
